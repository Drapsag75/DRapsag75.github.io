document.addEventListener('DOMContentLoaded', () => {
    ...
    async function startBruteForce() {
        ...
        const totalCombinations = 4 * 4 * 4;
        let currentCombinationIndex = 0;

        while (isBruteForcing) {
            currentCombinationIndex++;
            updateProgress(currentCombinationIndex, totalCombinations);
        ...
        if (currentCombination[2] > 4) {
            ...
            if (currentCombination[1] > 4) {
                ...
                if (currentCombination[0] > 4) {
                    ...
                    bruteForceButton.textContent = 'Brute Force';
                    document.body.removeChild(document.getElementById('brute-force-progress'));
    ...
    function removeControlButtons() {
        ...
        const bruteForceButton = document.getElementById('brute-force-button');
        if (bruteForceButton) bruteForceButton.remove();
    }
